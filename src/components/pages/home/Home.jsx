...
const Home = () => {
  ...
  return (
    <section>
      <div className="section home-wave" id="home">
        <div className="container home__container">
          <div className="home__content">
            <div className="home__info flex">
            ...
            <div className="home__btns flex">
              ...
              <div className="home__btns-social flex">
                <a
                  className="btn btn-s btn-email"
                  target="_blank"
                ...
                <a
                  className="btn btn-s btn-github"
                  target="_blank"
                ...
                <a
                  className="btn btn-s btn-linkedin"
                  target="_blank"
                  href="https://linkedin.com/in/khwan-yyg"
                  title="Linkedin"
                >
                  <span>
        ...
        <div className="home__scroll flex flex-center ">
          <Link to="resumes" className="home__scroll-button flex flex-center ">
            <svg
              width="32px"
              height="32px"
            ...
            <i className="bx bx-chevrons-down home__scroll-arrow wheel"></i>
          </Link>
        </div>
      </div>
    </section>
